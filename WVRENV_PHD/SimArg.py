...
len_max = 12000             # 单轮仿真的步长上限

fighters_max_num = 50        # 设定仿真环境内的飞机的数量
num_blue = 1                 # 设定蓝色机数量
num_red = 1                  # 设定红色机数量
missiles_max = 0            # 设定每架飞机搭载的近距导弹的数量
missiles_max_mid = 0        # 设定每架飞机搭载的中距导弹的数量
...
class InitialData(object):
    def __init__(self):
        ...
        self.originLongitude = 96.3   # 仿真的经纬度原点位置
        self.originLatitude = 32.8
